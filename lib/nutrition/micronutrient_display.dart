...
/// Shared per-key colour for micronutrient progress rows and badges. Mirrors the
/// palette used on the diary day view and dish card so the same nutrient keeps
/// the same colour everywhere. Unknown keys fall back to a neutral green.
Color micronutrientColor(String key) => switch (key) {
